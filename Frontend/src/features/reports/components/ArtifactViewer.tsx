  ...
  return (
    <div className="mt-3 space-y-3">
      {video && (
        <video
          controls
          className="w-full rounded-lg border border-linea bg-black"
      ...
      <div className="flex flex-wrap gap-2">
        {screenshot && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-1 rounded-lg border border-linea px-3 py-1.5 text-xs text-texto-tenue hover:bg-superficie"
          >
            <Image size={14} />
            Screenshot
          </a>
